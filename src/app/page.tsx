  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg mx-auto mb-12">
        ...
        <ul>
          <li>
            <strong>Your Archive:</strong> Write editorial-style journal entries meant to be read
            later — months or even years from now. Tag them, organize them, and keep them private,
